      ...
      <div className="w-full max-w-3xl mx-auto px-4 sm:px-8">
        ...
        <div className="flex-grow flex flex-col items-center justify-center py-4">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-instrument-serif text-white tracking-wide">
              Agenda
            </h1>
          </div>
                  ...
                  {sortedDates.map((dateKey) => (
                    <div key={dateKey} className="space-y-4">
                      ...
                      <div className="text-left mb-3">
                        <Badge
                          variant="secondary"
                          className="text-lg px-4 py-2 bg-white border-gray-200 text-gray-900 font-instrument-serif"
                        >
