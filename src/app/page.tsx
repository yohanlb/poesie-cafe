    ...
    <main className="h-dvh bg-background text-white flex flex-col max-w-screen-2xl mx-auto">
      <div className="flex-1 flex flex-col spacing-section">
        ...
        <header className="flex justify-between items-start spacing-hero mt-2">
          <h1 className="text-title -mt-4 animate-fade-in-2">Poésie</h1>
          <div className="text-address text-right animate-fade-in-3">
        ...
        <div className="flex-1 flex flex-col justify-center min-h-0">
          <p className="text-hero w-full sm:max-w-[85%] animate-fade-in-1">
            ...
            <span className="line-break-3">
              ...
              <Link
                href="/agenda"
                className="text-link decoration-1 underline underline-offset-4 hover:decoration-2 animate-fade-in-4 no-break"
              >
                agenda
              </Link>
            </span>
        ...
        {/* Bottom Text */}
        <p className="text-subtitle mt-auto animate-fade-in-5">
