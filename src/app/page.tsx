...
export default function Home() {
    ...
    <main className="h-screen bg-[var(--background-blue)] text-white flex flex-col max-w-screen-2xl mx-auto">
      <div className="flex-1 flex flex-col p-[clamp(1rem,3vw,4rem)]">
        ...
        <header className="flex justify-between items-start mb-[clamp(2rem,5vh,6rem)] mt-2">
          ...
          <h1 className="text-[clamp(4rem,10vw,6.5rem)] leading-[1.3] font-instrument-serif -mt-4 animate-fade-in-2">
            Poésie
          </h1>
          <div className="text-[clamp(1.2rem,3vw,3.5rem)] leading-[1.3] font-instrument-serif text-right animate-fade-in-3">
 ...
 underline underline-offset-4 hover:decoration-2 animate-fade-in-4"
            >
              agenda
            </Link>
          </p>
        ...
        {/* Bottom Text */}
        <p className="text-[clamp(1.8rem,5vw,5.5rem)] leading-[1.3] font-instrument-serif mt-auto animate-fade-in-5">
